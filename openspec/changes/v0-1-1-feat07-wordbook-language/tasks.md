...
- [ ] 1.1 `Shared/Constants.swift`：`supportedWordLanguages` 注册表、`languageDetectionSampleCount=20`、`languageDetectionConfidenceThreshold=0.5`
...
- [ ] 4.5 手动验证（用户）：导入多语种 TXT → 发音页出现新分区；菜单"语言…"修改 → 分区即时变化；收藏夹无语言项
